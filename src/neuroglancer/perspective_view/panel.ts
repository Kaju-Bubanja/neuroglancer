...
import { kAxes, mat4, vec3, transformVectorByMat4, vec4, mat3 } from 'neuroglancer/util/geom';
...
import { StereoPerspectivePanelLayout } from 'neuroglancer/viewer_layouts';
...
export class PerspectivePanel extends RenderedDataPanel {
  ...
  otherRenderedDataPanel: PerspectivePanel;
